...
export interface WebsiteMobileMenuProps {
  isModalOpen: boolean;
  closeModal: () => void;
...
export const WebsiteMobileMenu: React.FunctionComponent<WebsiteMobileMenuProps> = ({
  isModalOpen,
  closeModal,
  navLinks,
  currentUrl,
  ...
  return (
    <>
      {isModalOpen ? (
        <div className="fixed inset-0 z-50 m-0 h-full w-full bg-white">
