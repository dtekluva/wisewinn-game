...
interface MobileSlideBackButtonProps {
...
export const MobileSlideBackButton: React.FunctionComponent<MobileSlideBackButtonProps> = ({
  ...
  return (
    <button
      ...
      className={clsx(
        'absolute top-[20%]  rounded-full bg-wise-purple-dark md:hidden',
        isHidden && 'hidden md:hidden',
        isDirectionForwards && 'right-px',
        !isDirectionForwards && 'left-px',
      )}
    >
      <svg
        width="54"
