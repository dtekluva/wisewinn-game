...
import { AiFortuneWebsiteMobileMenu } from './AiFortuneWebsiteMobileMenu';

const LandingAiFortunePageHeader = () => {
            ...
            <Link href="/ask-ai">
              <a className="inlineflex-1 overflow-visible">
                <div className="flex items-center gap-x-4">
                  ...
                  <p className="text-base font-semibold text-white lg:text-2xl">Glo AI fortune</p>
                </div>
              </a>
            </Link>
          )}
...
export default LandingAiFortunePageHeader;
